...
use bevy::{
  ecs::spawn::SpawnIter, input::common_conditions::input_just_pressed,
};
...
pub(super) fn plugin(app: &mut App) {
  ...
  app.configure_loading_state(
    LoadingStateConfig::new(Game::Loading).load_collection::<CreditsAssets>(),
  );
